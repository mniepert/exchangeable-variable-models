...
class MComponent:
	...
	def __init__(self, data, part):
		...
		# perform Laplacian smoothing -> add constant (alpha) to each possible configuration
...
data_train_raw = load_files("reuters/train")

y_train_all = data_train_raw.target
X_train_all = data_train_raw.data

data_test_raw = load_files("reuters/test")
...
for categoriesTuple in REUTERSCombinations:
	...
	# keep track of test set statistics
