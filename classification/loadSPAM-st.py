...
for a in arange(numCombinations):
	...
	data_raw = load_files("spam/enron1", shuffle=True, random_state=randint(1,10000))

	# split a training set and a test set
	y_train, y_test = data_raw.target[:4000], data_raw.target[4000:5000]

	X_both = data_raw.data

	X_train = X_both[:4000]
	X_test =  X_both[4000:5000]
