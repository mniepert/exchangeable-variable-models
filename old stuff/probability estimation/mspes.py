...
for i in arange(numMixtures):
	...
	#shuffle(ms)	
	#centers,assign = kmeans2(ms, randint(1,10))
	#assign = zeros(nv, dtype=int)	
	assign = array([11, 13, 11, 7, 14, 1, 22, 26, 23, 18, 16, 16, 11, 8, 11, 7, 5, 17, 21, 17, 17, 15, 16, 6, 11, 18, 13, 16, 18, 17, 17, 14, 6, 21, 9, 7, 12, 12, 9, 18, 18, 2, 9, 11, 11, 25, 18, 17, 15, 10, 19, 18, 4, 10, 18, 7, 12, 13, 16, 3, 24, 16, 4, 18, 20, 17, 16, 21, 11])
	#shuffle(assign)
	#print assign
...
assign = zeros(nv, dtype=int)	
comp = append(comp, MComponent(data, assign))
