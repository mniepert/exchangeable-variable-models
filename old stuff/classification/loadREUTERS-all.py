...
#X_train_all = ch2.fit_transform(X_train_all, y_train_all)
#X_test_all = ch2.transform(X_test_all)

X_train_all = X_train_all.toarray()
X_test_all = X_test_all.toarray()

REUTERSCombinations = list(combinations(unique(y_train_all), 8))
...
blockSizeStatistics = zeros(8*numCombinations, dtype=float)
