...
# specify the data set (as an array)
#dataSetList = ["nltcs", "msnbc", "kdd", "plants", "baudio", "jester", "bnetflix", "msweb", "book", "cwebkb", "cr52", "c20ng"]
dataSetList = ["plants", "baudio", "jester"]
...
for dataSetName in dataSetList:
	...
	print "Mixture of EVMs: ",sumn / float(mt)
